...
st.markdown("---")
st.markdown("## 🧠 Thinking Task – Viva")

st.markdown("""
Students should be able to **explain verbally**:

1️⃣ **What is an AI Interview Coach?**  
2️⃣ **Why is Streamlit used in this project?**  
3️⃣ **Where does AI run – locally or online?**
""")
